...
-- Student Fees for Aisha Khan (PAR001's child, Class 10B)
INSERT INTO student_fees (id, school_id, student_id, fee_category_id, amount, due_date, status, paid_at) VALUES
('ee000001-0000-0000-0000-000000000010', 101, '4d5e6f70-8901-2345-def0-234567890123', 'ff000001-0000-0000-0000-000000000001', 15000.00, '2026-07-10', 'PAID', '2026-03-25 11:30:00'),
('ee000001-0000-0000-0000-000000000011', 101, '4d5e6f70-8901-2345-def0-234567890123', 'ff000001-0000-0000-0000-000000000002', 3000.00, '2026-07-10', 'PAID', '2026-03-25 11:35:00'),
('ee000001-0000-0000-0000-000000000012', 101, '4d5e6f70-8901-2345-def0-234567890123', 'ff000001-0000-0000-0000-000000000003', 2000.00, '2026-07-15', 'PENDING', NULL)
ON CONFLICT (id) DO NOTHING;
...
('11000001-0000-0000-0000-000000000001', 101, 'f8f36a25-8bf8-4df8-be47-30a4f0a4e811', 'ee000001-0000-0000-0000-000000000003', 2000.00, 'UPI', 'TXN20260320143012', 'PAID', '2026-03-20 14:30:00'),
-- Rahul's Tuition Fee: failed attempt via CARD
('11000001-0000-0000-0000-000000000002', 101, 'f8f36a25-8bf8-4df8-be47-30a4f0a4e811', 'ee000001-0000-0000-0000-000000000001', 15000.00, 'CARD', 'TXN20260315091500', 'FAILED', '2026-03-15 09:15:00'),
-- Priya's Transport Fee: paid via UPI
('11000001-0000-0000-0000-000000000003', 101, '0540f78d-8479-4d11-bd41-d3fd2b014db4', 'ee000001-0000-0000-0000-000000000005', 3000.00, 'UPI', 'TXN20260318100030', 'PAID', '2026-03-18 10:00:00'),
-- Priya's Exam Fee: paid via NET_BANKING
('11000001-0000-0000-0000-000000000004', 101, '0540f78d-8479-4d11-bd41-d3fd2b014db4', 'ee000001-0000-0000-0000-000000000006', 2000.00, 'NET_BANKING', 'TXN20260318100530', 'PAID', '2026-03-18 10:05:00'),
-- Aisha's Tuition Fee: paid via UPI
('11000001-0000-0000-0000-000000000005', 101, '4d5e6f70-8901-2345-def0-234567890123', 'ee000001-0000-0000-0000-000000000010', 15000.00, 'UPI', 'TXN20260325113045', 'PAID', '2026-03-25 11:30:00'),
-- Aisha's Transport Fee: paid via UPI
('11000001-0000-0000-0000-000000000006', 101, '4d5e6f70-8901-2345-def0-234567890123', 'ee000001-0000-0000-0000-000000000011', 3000.00, 'UPI', 'TXN20260325113530', 'PAID', '2026-03-25 11:35:00')
ON CONFLICT (id) DO NOTHING;
