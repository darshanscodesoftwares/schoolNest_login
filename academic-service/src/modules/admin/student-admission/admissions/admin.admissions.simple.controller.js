// ============================================================
// SIMPLE UNIFIED SAVE DRAFT CONTROLLER
// ============================================================
// ONE endpoint for all sections - NO studentId in URL needed
// POST /api/v1/academic/admin/admissions/save-draft
// Automatically creates or finds studentId

const pool = require("../../../../config/db");

// ============================================================
// UNIFIED SAVE DRAFT - NO studentId required
// ============================================================
// POST /api/v1/academic/admin/admissions/save-draft
// Body: { studentId, section: "personal|academic|...", data: {...} }

async function saveDraftSimple(req, res) {
  try {
    let { studentId, section, data } = req.body;
    ...
    if (!studentId) {
      const createResult = await pool.query(
        `INSERT INTO admissions (school_id, status)
         VALUES ($1, $2)
